<?php
// File: admin/reports_sales.php

$page_title = 'Laporan Penjualan'; // Judul untuk header
...
<div class="bg-white p-6 rounded-xl shadow-lg">
    <h2 class="text-xl font-bold text-gray-800 mb-6 border-b pb-4">📊 Laporan Penjualan</h2>

    <form id="salesReportFilterForm" class="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
        <div>
    ...
    <div class="bg-gray-50 p-4 rounded-lg mb-6">
        <p class="text-gray-700 text-lg font-semibold">Total Penjualan (Kg): <span id="totalSalesKg" class="text-blue-600">0</span></p>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white">
            <thead class="bg-gray-200">
                <tr>
                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">ID Penjualan</th>
            ...
            <tbody id="salesReportTableBody" class="text-gray-700">
                <tr>
                    <td colspan="7" class="text-center p-4">Silakan pilih rentang tanggal dan klik "Tampilkan Laporan".</td>
                </tr>
            </tbody>
        </table>
    </div>
